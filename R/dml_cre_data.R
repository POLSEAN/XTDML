...
#' `dml_cre_data` construct a synthetic data set suitable for panel data analysis.
#'
#' `dml_cre_data` objects can be initialized from a
#' [data.table][data.table::data.table()]. Alternatively `dml_cre` provides
...
#'
#' @return Creates a new instance of class `dml_cre_data`.
#'
#' @export
dml_cre_data_from_data_frame = function(df,
